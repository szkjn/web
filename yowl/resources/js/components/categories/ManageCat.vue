<template>
  <div class="container">
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <tr v-for="category in $store.state.categories" :key="category.id">
              ...
              <td v-if="newCategory.id == category.id">
        ...
        <div class="card-wrapper">
          <div class="card-container" v-on-clickaway="hidePostDetails">
            <body class="d-flex flex-column">
              <div>
                <div @click="newCategory = ''" id="close">
                  <svg
                    class="m-2"
                    fill="none"
                    viewBox="0 0 24 24"
             ...
             <form @submit.prevent="updateCategory" class="catForm">
                ...
                <div class="modal-body">					
                  <div class="form-group">
                    <label>Name</label>
                    <input class="form-control" type="text" name="name" v-model="newCategory.name">
                    
                  </div>				
                </div>
                <div class="modal-footer">
                  <input type="button" class="btn btn-default"  value="Cancel" @click="newCategory = ''">
    ...
    <CreateCat v-if="create" @hideForm="create=false" />
...
export default {
  ...
  methods: {
    ...
    updateCategory(e) {
			...
			this.$store.state.currentCategory = this.newCategory
